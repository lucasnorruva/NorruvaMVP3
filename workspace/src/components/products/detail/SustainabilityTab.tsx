    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-3">
          {product.repairabilityScore && (
            <div>
              ...
              <p className="text-foreground/90">
                <span className="font-bold text-xl text-blue-700">{product.repairabilityScore.value}</span> / {product.repairabilityScore.scale}
                {product.repairabilityScore.reportUrl && (
                  <Link href={product.repairabilityScore.reportUrl} target="_blank" rel="noopener noreferrer">
          ...
          {!product.repairabilityScore && !product.sparePartsAvailability && !product.repairManualUrl && !product.disassemblyInstructionsUrl && !product.recyclabilityInfo && (
