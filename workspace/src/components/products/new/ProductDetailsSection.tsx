...
interface ProductDetailsSectionProps {
  ...
  isGeneratingImage: boolean; // Added
  setIsGeneratingImage: (loading: boolean) => void; // Added
}
...
export default function ProductDetailsSection({
  ...
  onSubmit,
  editProductId,
  isGeneratingImage, // Destructure
  setIsGeneratingImage, // Destructure
  ...
  return (
    <>
      ...
      <ProductForm
        ...
        isGeneratingImage={isGeneratingImage} // Pass down
        setIsGeneratingImage={setIsGeneratingImage} // Pass down
      />
    </>
  );
}
