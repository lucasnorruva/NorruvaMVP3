...
import { Scale, Settings, Info, Database as DatabaseIcon, Anchor, UserCheck, BatteryCharging, Shirt, Construction } from "lucide-react"; // Added Shirt, Construction
        ...
        <CardContent className="space-y-6">
            <section>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                    Specific product categories under ESPR, such as textiles and construction products, have dedicated data structures within the DPP:
                </p>
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-0.5 mt-1 pl-4">
                    <li><strong className="text-foreground/80">Textiles:</strong> Captured in the <code className="bg-muted px-1 rounded-sm font-mono text-xs">textileInformation</code> object, including <code className="bg-muted px-1 rounded-sm font-mono text-xs">fiberComposition</code>, <code className="bg-muted px-1 rounded-sm font-mono text-xs">countryOfOriginLabeling</code>, and <code className="bg-muted px-1 rounded-sm font-mono text-xs">careInstructionsUrl</code>.</li>
                    <li><strong className="text-foreground/80">Construction Products (CPR):</strong> Captured in the <code className="bg-muted px-1 rounded-sm font-mono text-xs">constructionProductInformation</code> object, including <code className="bg-muted px-1 rounded-sm font-mono text-xs">declarationOfPerformanceId</code>, <code className="bg-muted px-1 rounded-sm font-mono text-xs">ceMarkingDetailsUrl</code>, and <code className="bg-muted px-1 rounded-sm font-mono text-xs">essentialCharacteristics</code>.</li>
                </ul>
