...
export const MOCK_PUBLIC_PASSPORTS: Record<string, PublicProductInfo> = {
  "PROD001": {
    ...
    repairabilityScore: { value: 8.5, scale: 10, reportUrl: "https://greentech.com/repair/X500-ECO-report.pdf" },
  ...
  "PROD006": { 
    ...
    complianceSummary: "Complies with EU Construction Products Regulation (CPR). Declaration of Performance available. CE Marked. SCIP Not Required.",
